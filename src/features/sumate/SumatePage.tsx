...
import { registrarInteres } from "@shared/api/agendaApi";
...
export function SumatePage() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    if (!nombreValido) nuevosErrores.nombre = sumate.errorNombre;
    if (!emailValido) nuevosErrores.email = sumate.errorEmail;
