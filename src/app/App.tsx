...
const MethodologyPage = lazy(() =>
  import("@features/metodologia").then((m) => ({
    default: m.MethodologyPage,
  })),
);
const DeliverablesPage = lazy(() =>
  import("@features/que-entrego").then((m) => ({
    default: m.DeliverablesPage,
  })),
);
const ArchitecturePage = lazy(() =>
  import("@features/arquitectura").then((m) => ({
    default: m.ArchitecturePage,
  })),
);
const TechnologiesPage = lazy(() =>
  import("@features/tecnologias").then((m) => ({
    default: m.TechnologiesPage,
  })),
);
const TeamPage = lazy(() =>
  import("@features/nosotros").then((m) => ({ default: m.TeamPage })),
);
const ParticipatePage = lazy(() =>
  import("@features/participar").then((m) => ({
    default: m.ParticipatePage,
  })),
);
const SumatePage = lazy(() =>
  import("@features/sumate").then((m) => ({ default: m.SumatePage })),
);
const ModificarPage = lazy(() =>
  import("@features/modificar").then((m) => ({ default: m.ModificarPage })),
);
const PanelPage = lazy(() =>
  import("@features/panel").then((m) => ({ default: m.PanelPage })),
);
const PrivacyPage = lazy(() =>
  import("@features/privacidad").then((m) => ({ default: m.PrivacyPage })),
);
