...
import photo from "@shared/assets/insta2.jpeg";
...
export const content: Content = {
  ...
  modificar: {
    ...
    errorNombre: "Ingresá tu nombre.",
    errorEmail: "Ingresá un email válido.",
    errorUrl: "Ingresá la URL de tu sitio (ej. https://tusitio.com).",
    errorQueCambiar: "Contanos qué querés cambiar de tu sitio.",
